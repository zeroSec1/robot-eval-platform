...
// confusion once (see /docs or team history — the "predicts failure
// before it happens" pitch language was walked back for exactly this
// reason).
//
 ...
 * construction — guarantees P(p-value <= alpha) <= alpha under
