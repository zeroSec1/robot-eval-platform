...
export type BlogBlock =
  ...
  | { type: "figure"; figure: "outcomes" | "envelope" | "timing" | "usecases" | "questions" | "raas-chart" | "raas-grid" | "bankruptcy" | "payback" | "funnel" | "timeline" | "funding" | "scorecard" | "comparison" | "record" | "detectability" | "claims" | "rate-questions" | "heights" | "floors" | "hinge" | "clauses" | "sheet" | "standards" | "claims-evidence" | "update-playbook" };
...
export const BLOG_POSTS: BlogPost[] = [
  {
    slug: "trade-show-vendor-questions",
    title: "Five minutes at a booth: a printable sheet for the trade show floor",
    date: "2026-08-06",
    summary:
      "MODEX 2026 had 1,057 exhibitors. You cannot do diligence on a show floor, but you can ask questions whose answers, and the pause before them, tell you something. Eleven questions, plus a card showing which standard covers what, so you stop citing a performance standard for a safety question.",
    tags: ["buyer-guide", "warehouse-robotics", "trade-shows"],
    body: [
      { type: "p", text: "MODEX 2026 drew 1,057 exhibitors across 630,000 square feet of floor [1]. Even walking briskly, you will speak to a few dozen at most. So the show floor is not where you evaluate anyone. It is where you decide who is worth evaluating later." },
      { type: "p", text: "That is a different task, and it needs different questions. Not the deep commercial ones you ask before signing, which we have written about separately. Short ones a person standing at a booth can answer, where the pause before the answer is itself information." },
      { type: "p", text: "One thing worth saying plainly: MHI, which runs these shows, publishes a great deal for attendees. An expo guide, floor plans, an exhibitor directory, a session planner, and templates to help you convince your manager to send you. It publishes nothing on how to evaluate the vendors once you arrive. This sheet is our attempt at the missing page." },
      { type: "h2", text: "The sheet" },
      { type: "p", text: "Print it, or keep it on your phone. Each question has a note on what a good answer sounds like." },
      { type: "figure", figure: "sheet" },
      { type: "p", text: "If you only use one line, use the third in the second group: will you put that number in a pilot contract as an acceptance test? Every performance claim is free until it is contractual. The answer sorts vendors faster than anything else on the sheet, and it costs you nothing to ask." },
      { type: "p", text: "A note on the numbers you will be quoted. We audited the pick rate and throughput claims published by several large vendors and found that not one stated the conditions it was measured under. So treat any rate you hear on the floor as a starting point for a question, not as a fact you can compare against the booth next door." },
      { type: "h2", text: "Name the right standard" },
      { type: "p", text: "Standards come up constantly at these shows, and they are easy to get wrong in a way that costs you credibility. The most common error is treating ASTM F45 as a safety credential. It is not a safety committee. It writes performance test methods." },
      { type: "figure", figure: "standards" },
      { type: "p", text: "The quote in that third row is the useful one, because it is ASTM saying it about itself. Their navigation test method states in its own scope that it does not address safety concerns. It points the reader at ANSI/ITSDF B56.5 and ISO 3691-4 instead [2]. If a vendor offers an F45 test result as evidence their machine is safe, that sentence settles it politely." },
      { type: "p", text: "Two practical notes. B56.5, the driverless industrial vehicle safety standard, is free on request from ITSDF, which asks only for your name, company and email and that you not resell it [3]. And the mobile robot safety series has a part aimed at you rather than the maker. R15.08 part 3 covers the use of these applications, and was published in 2026 [4]." },
      { type: "h2", text: "The one question to ask about safety" },
      { type: "p", text: "If you take one compliance question to the floor, take this: who produces the task-based risk assessment, and when do I see it?" },
      { type: "p", text: "OSHA's own technical manual says the assessment should be completed by the integrator, with your users and workers involved, before commissioning [5]. It also puts the point more bluntly than we would dare to: it is not enough to simply trust the integrator, or to perform a simple visual inspection alone [5]." },
      { type: "p", text: "That manual is US government text, free to read and quote, and it doubles as an evaluation checklist. One caveat we should flag. The page carries no revision date, and it still refers to the 2012 edition of the flagship robot safety standard, which was revised in 2025. So use it for its structure and its reasoning, and check editions yourself." },
      { type: "h2", text: "What to do on the plane home" },
      { type: "p", text: "Turn the shortlist into two or three requests, sent the same week while you are still a face they remember." },
      { type: "ol", items: [
        "Ask for every quoted number again, in writing, with its measurement conditions attached. Per what, over how long, on what order profile.",
        "Ask for one reference site that resembles yours, rather than the best site they have.",
        "Ask whether the headline number can become an acceptance test in a pilot agreement. The answer to this is the real shortlist.",
      ] },
      { type: "p", text: "Then take whatever comes back and set your pass mark before anyone runs anything. That order matters more than which vendor you picked, and we say so from experience. In our own first evaluation we chose a looser bar than the benchmark's. That alone turned a dataset where nothing clears the standard into a 48.1% headline. We published the correction." },
      { type: "h2", text: "Dates, if you are planning" },
      { type: "p", text: "MODEX 2026 has already been and gone. It ran from 13 to 16 April 2026 in Atlanta. The next MHI show is ProMat 2027, in Chicago's McCormick Place from 19 to 21 April 2027 [1]. Note that it is three days rather than the usual four. MHI has also announced a third show, MODEX West, debuting in Las Vegas in October 2028. Two MHI releases published a week apart give different end dates for MODEX 2028, so we are not stating one." },
      { type: "h2", text: "Sources" },
      { type: "p", text: "Show facts are from MHI's own site and press releases, read in August 2026. We report registered visitors rather than attendance, because registration is what MHI publishes. We have deliberately left out MHI's survey statistics on automation adoption and spending: the figures we could reach are five-year predictions of intent rather than measured adoption, and the underlying report sits behind a form we did not submit." },
      { type: "ol", items: [
        "MHI press release, 20 April 2026, modexshow.com: 'The 2026 event, sponsored by MHI, welcomed 50,000 registered visitors from every U.S. state and 132 countries, alongside 1,057 exhibitors covering 630,000 net square feet'; 'ProMat 2027 will be held in Chicago's McCormick Place from April 19-21, 2027.'",
        "ASTM F3244-21, Standard Test Method for Navigation: Defined Area, scope clause 1.3, astm.org: 'This standard does not purport to address all of the safety concerns, if any, associated with its use. Safety standards such as ANSI/ITSDF B56.5, ISO 3691-4:2020, or other safety standards should be followed.'",
        "ITSDF B56 standards page, itsdf.org: 'ANSI/ITSDF B56.5-2024, Safety Standard for Driverless, Automatic Guided Industrial Vehicles and Automated Functions of Manned Industrial Vehicles EFFECTIVE 12/16/25'; 'Copies of these standards are available for free upon request'.",
        "ANSI/A3 R15.08-3-2026, American National Standard for Industrial Mobile Robots, Safety Requirements, Part 3: Use of IMR Applications, listed in the A3 standards store at automate.org.",
  ...
  },
  {
    ...
    body: [
      ...
      { type: "h2", text: "The license election, and what it does not buy" },
      { type: "p", text: "Say a bankrupt licensor rejects your software license. US law lets you elect to keep your rights for the rest of the term, provided you keep paying [2]. That is the strongest protection on this list. It is also narrower than it sounds." },
      ...
      { type: "p", text: "The license election protects intellectual property. It does not protect equipment. And the Code's protection for rejected leases, section 365(h), covers leases of real property only [14]. No part of section 365 protects a lessee of personal property when a bankrupt lessor rejects the lease." },
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "We scored the LeRobot PushT dataset [1]: 52 recorded trials of a simple pushing task, where a robot pushes a T-shaped block onto a T-shaped target. We fixed our pass mark before scoring: a peak coverage reward of at least 0.9. By that bar, 25 of 52 trials pass, a 48.1% rate. The median passing trial runs 13.6 s. The median failing trial runs 10.5 s. A real-robot PushT set from Open X-Embodiment [4] scores 8 of 8 successes, but read that with care: those episodes were scored by a different and stricter rule, a reward pulse reaching 1.0, so the two numbers are not comparable. At the time of this analysis, the platform's other 248 of its 308 episodes had no automatic pass mark, so they stayed unscored. We would rather publish that than invent a number. (The platform has since added a third, human-evaluated real-policy dataset with real pass/fail labels; see the Methodology page for what changed.)" },
      ...
      { type: "p", text: "This is the shape of evaluation we think buyers deserve on their own pilots. Pass mark fixed first. Every trial instrumented. Failure timing analyzed, not averaged away. Error rates disclosed. Everything reproducible from raw data. If the reports on your desk do not look like this, it is worth asking why." },
    ],
  },
  {
    slug: "robot-policy-updates-insurance",
    title: "A new policy is a new product: what robot software updates mean for liability and insurance",
    date: "2026-08-06",
    summary:
      "When Tesla recalled 2,031,220 vehicles, the recalled part was software and the fix was a push. From December 2026, EU law holds makers liable for defects caused by updates, and for safety updates they failed to ship. The answer regulators reward is not freezing your model. It is a tested update pipeline you can show an underwriter.",
    tags: ["vendor-guide", "insurance", "warehouse-robotics"],
    body: [
      { type: "p", text: "A robot's behavior is its policy: the trained model that decides what the arm or the vehicle does next. Vendors update these models the way phone apps update. Each push changes how a fleet behaves at customer sites. The law has begun to treat each push as a change to the product itself. Insurers can already see software differences in loss data. This post lays out both, with the primary sources quoted so you can check every word." },
      { type: "p", text: "First, our limits. We are not lawyers and we are not brokers; nothing here is legal or placement advice. We sell robot evaluation, so we have an interest in the conclusion, and you should read us knowing that. Every claim below carries a numbered source. Where the record is thin we say so in the text. One example: we found no public source showing an insurer re-price a fleet per software version. What the record does show is strong enough." },
      { type: "h2", text: "In the EU, a software update can create a defect you are liable for" },
      { type: "p", text: "The EU rewrote its product liability law in 2024. The new directive counts software as a product outright, and it applies to products placed on the market or put into service after 9 December 2026 [1]." },
      ...
      { type: "p", text: "It goes further. Make a substantial change 'through a software update or upgrade, or due to the continuous learning of an AI system', and the clock restarts [1]. The directive treats the changed product as newly made available on the market, or put into service, at that moment. Read that as a robot vendor. A big enough policy update means you shipped a new product, with a new product's exposure." },
      { type: "p", text: "No court has applied this to a warehouse robot yet; the directive is new and untested. But the direction is written down, in force, and dated." },
      { type: "h2", text: "Cars already live under this regime" },
      { type: "p", text: "Vehicle regulators got here first. UN Regulation No. 156 requires makers of software-updatable vehicles to run a documented update process [2]. Before an update ships, the maker must assess whether it 'will add, alter or enable any functions' that were not present when the vehicle was approved [2]. It must record that the update 'successfully passed verification and validation procedures' [2]. Each relevant software version must carry its own unique ID. A failed update must roll back to the old version, or the vehicle must reach a safe state [2]." },
      { type: "p", text: "The US shows what enforcement looks like. In February 2023, Tesla recalled 362,758 vehicles over Full Self-Driving Beta behavior. The recall report lists the component as 'Vehicle Software', and the remedy was an over-the-air update [3]. Tesla stated it did not concur with the agency's analysis and knew of no related injuries [3]. Ten months later, a second recall covered 2,031,220 vehicles, again remedied by a software push [4]." },
      { type: "p", text: "Note what these recalls are and are not. In both, existing software behavior was the defect and an update was the cure. We did not find a US recall caused by a bad update pushed to a fleet, and we looked. The mechanism still cuts both ways: once a regulator treats software as a component, every version you ship is a component change." },
      { type: "h2", text: "Insurers can already see software in the loss data" },
      { type: "figure", figure: "claims-evidence" },
      { type: "p", text: "The chart makes a narrow point. What software a machine runs shows up in crash and claim data, feature by feature. The insurance industry's own research arms measure it [5]. Waymo and Swiss Re went further. They compared a driverless fleet's liability claims to human baselines built from over 500,000 claims. Waymo reports an 88% drop in property damage claims across 25.3 million miles [6]. That figure is the company's own account of a study it co-wrote, so treat it as a vendor number." },
      { type: "p", text: "Reinsurers have also begun underwriting model performance directly. Munich Re sells cover that lets an AI vendor 'indemnify your clients for their financial losses or legal liabilities directly related to AI errors' [7]. Lloyd's wrote back in 2019 that liability may shift from human drivers to AV makers, and that recalls 'could become larger and more complex' [8]. None of this is a robotics actuarial table. It is the machinery being built around one." },
      { type: "h2", text: "An update that lifts the average can still regress" },
      { type: "p", text: "Here is the part our own work touches. Model updates do not improve uniformly. The research literature calls the failures 'negative flips': cases the old model handled correctly that the new model gets wrong, even when overall accuracy rises [9][11]." },
      { type: "p", text: "Two more results are worth carrying into any update review. Updates that raise a model's accuracy can still hurt the human teams built around it [10]. And retraining can change behavior even when the data has not shifted, from optimization randomness alone [11]." },
      { type: "p", text: "This is why per-episode comparison exists on our platform. An update gate has to see which cases flipped, not just whether the average moved. One disclosure: our public demo data holds two policies tested on different tasks. It cannot show a true same-task update regression. The research above is the evidence base. Our tooling is built for the day your own fleet generates the comparison." },
      { type: "h2", text: "Regulators reward a validated update pipeline" },
      { type: "p", text: "The strictest regimes do not demand a fresh approval for every model change. They demand a tested change process, and they reward it. The FDA now approves a 'predetermined change control plan' for AI devices [12]. The plan describes the changes you intend, how you will validate them, and their impact. Updates that follow the plan ship without a new submission [12]. The EU AI Act mirrors this. Changes the provider pre-declared in the first assessment are not a 'substantial modification'. For high-risk systems, unplanned changes that affect compliance or the intended purpose trigger a new conformity assessment [13]." },
      { type: "p", text: "Even OSHA's manual for industrial robots says the risk assessment documentation should be 'reviewed if any changes are made to the robot application' [14]." },
      { type: "figure", figure: "update-playbook" },
      { type: "p", text: "None of the six is exotic. Together they are the proof that update risk is managed. The reader who asks for that proof may be a regulator today. Soon it may be an underwriter." },
      { type: "h2", text: "What this means when you talk to your insurer" },
      { type: "ul", items: [
      ...
      { type: "ol", items: [
        ...
        "Munich Re, aiSure product page, munichre.com: 'aiSure-backed performance warranties enable you to indemnify your clients for their financial losses or legal liabilities directly related to AI errors.' The page does not discuss update versioning; we cite it only for model performance being insurable.",
        "Lloyd's, Taking control: artificial intelligence and insurance, Emerging Risk Report 2019, lloyds.com: liability may shift 'from human drivers to automated vehicles (AVs), and therefore to the manufacturers'; 'In general, recalls could become larger and more complex'.",
        "Yan et al., Positive-Congruent Training: Towards Regression-Free Model Updates, arXiv:2011.09161: 'A new model incorrectly predicts the output for a test sample that was correctly classified by the old (reference) model.'",
        "Bansal et al., Updates in Human-AI Teams, AAAI 2019: 'updates that increase AI performance may actually hurt team performance'.",
        "Srivastava et al., An Empirical Analysis of Backward Compatibility in Machine Learning Systems, KDD 2020, microsoft.com/research: 'updates, intended to improve ML models, can introduce new errors'; 'compatibility issues arise even without data shift due to optimization stochasticity'.",
