...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "ol", items: [
        ...
        "GXO has publicly piloted humanoids from three vendors: Agility Robotics, Apptronik and Reflex Robotics. humanoidsdaily.com. Apptronik and GXO have separately described evaluating Apollo in a lab setting before deployment to a US distribution centre. therobotreport.com",
  ...
  },
  {
    ...
    date: "2026-08-05",
    summary:
      "Kroger wrote off $2.5 billion on automated fulfilment and paid $350 million to leave. The robots worked. The filings show four ordinary causes, warnings visible two years early, and not one published throughput number.",
    tags: ["case-study", "economics", "warehouse-robotics"],
    body: [
      { type: "p", text: "In November 2025 Kroger told the SEC it would take about $2.6 billion in impairment and related charges on its automated fulfilment network [1]. Two weeks later it filed again to add that the figure included a cash payment to its vendor, Ocado, of about $350 million [1]. Nothing had broken. No vendor went bankrupt. The robots worked." },
      ...
      { type: "p", text: "Sites in the wrong places. The same executive called locating the centres outside cities 'a key flaw' [5]. Kroger's annual report gives this away in an aside. It reports eCommerce growth 'excluding the effect of fulfillment center exits in markets where Kroger does not operate stores' [4]. Two of the three closed sites sat in markets with no Kroger stores to anchor them." },
    ...
    body: [
      ...
      { type: "ol", items: [
        ...
        "Model and figures: scripts/build-labor-model.py in the repository. All assumptions are listed in the article and in the script header.",
          ...
          "On ramp-up as a recognised but unquantified gap: Swisslog, Ramping Up Supply Chain Automation, Feb 2022 (defining go-live as the day order fulfilment begins, even at a few orders a day, with ramp-up the period to designed volumes); Tompkins Robotics, June 2026, describing ramp-up time as one of the most important but underestimated metrics; WarehousePMO on ramp planning. No published distribution of ramp durations was found.",
      ] },
    ],
  },
  {
